...
function Invite() {
  ...
  return (
    <div className="flex justify-center items-center p-3 my-6 h-auto rounded-lg shadow-inner border-1 !bg-white/10 !border-cyan-700 border-dashed cursor-pointer hover:!bg-cyan-300">
