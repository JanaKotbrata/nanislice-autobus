...
function LeaveAlert({ message, onClose, onConfirm }) {
  ...
  const content = (
    <div
      ...
      className="relative p-4 mb-4 rounded-lg !bg-gray-900 text-orange-400 !border-orange-800"
      role="alert"
    >
      <div className="flex items-center">
        <FaRegQuestionCircle className={"mr-2"} />
        <h3 className="text-lg font-medium">
          {i18n.translate("logOutAlertTitle")}
        </h3>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        >
          {i18n.translate("logOutAlertConfirm")}
        </button>
        <button
          type="button"
          onClick={onClose}
        ...
        >
          {i18n.translate("logOutAlertClose")}
        </button>
      </div>
    </div>
  );
