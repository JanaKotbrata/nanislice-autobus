...
function Member({ children, picture, isCreator, isMyself, role, level }) {
  ...
  return (
      ...
      <div className="flex items-center">
        ...
        <div className="sm:ml-2 flex flex-col leading-tight">
          <div className="text-sm font-semibold text-gray-600">{children}</div>
          {level !== undefined && (
            <div className="text-xs font-light text-gray-400">Level {level}</div>
          )}
