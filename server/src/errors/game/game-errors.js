...
class InvalidCardInBusStopDifferentIndex extends CommonError {
  constructor(params) {
    super(
      ...
      "Card in bus stop does not match the index",
    );
    this.status = 400;
    this.params = params;
  }
...
class GameAlreadyActive extends CommonError {
  constructor(params) {
    super(
      "GameAlreadyActive",
      "Game is already active is not possible to add player.",
    );
    this.status = 400;
    this.params = params;
  }
...
class UserIsNotAllowedToDeleteGame extends CommonError {
  constructor(params) {
    super(
      ...
      "User is not allowed to delete this game",
    );
    this.status = 403;
    this.params = params;
  }
...
class UserIsNotAllowedToCloseGame extends CommonError {
  constructor(params) {
    super(
      ...
      "User is not allowed to close this game",
    );
    this.status = 403;
    this.params = params;
  }
